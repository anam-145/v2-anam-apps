// Bitcoin Mnemonic Flow - Step 3: Mnemonic Verification
...
class MnemonicVerifyStep {
  ...
  createWordBank(words, verifyIndices) {
    ...
    // ================================================================
    // 더미 단어들 - UI/UX 목적으로만 사용
    // ================================================================
    // 이 단어들은 사용자의 니모닉 암기 검증 시 혼동을 주기 위한 가짜 선택지입니다.
    // 실제 지갑 생성이나 보안에는 전혀 영향을 주지 않습니다.
    // BIP39 표준 단어 목록에서 가져온 일반적인 단어들입니다.
    const dummyWords = [
