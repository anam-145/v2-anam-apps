// Solana Mnemonic Flow - Step 1: Security Warning
...
class SecurityWarningStep {
  ...
  handleSkip() {
    ...
    const skipCount = parseInt(localStorage.getItem('sol_mnemonic_skip_count') || '0') + 1;
    localStorage.setItem('sol_mnemonic_skip_count', skipCount.toString());
    localStorage.setItem('sol_mnemonic_skipped', 'true');
