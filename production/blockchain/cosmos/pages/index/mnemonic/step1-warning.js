// Cosmos Mnemonic Flow - Step 1: Security Warning
...
class SecurityWarningStep {
  ...
  handleSkip() {
    ...
    const skipCount = parseInt(localStorage.getItem('cosmos_mnemonic_skip_count') || '0') + 1;
    localStorage.setItem('cosmos_mnemonic_skip_count', skipCount.toString());
    localStorage.setItem('cosmos_mnemonic_skipped', 'true');
