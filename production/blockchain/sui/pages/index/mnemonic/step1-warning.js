// Sui Mnemonic Flow - Step 1: Security Warning
...
class SecurityWarningStep {
  ...
  handleSkip() {
    ...
    const skipCount = parseInt(localStorage.getItem('sui_mnemonic_skip_count') || '0') + 1;
    localStorage.setItem('sui_mnemonic_skip_count', skipCount.toString());
    localStorage.setItem('sui_mnemonic_skipped', 'true');
